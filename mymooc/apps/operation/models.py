...
class UserAsk(models.Model):
    ...
    mobile = models.CharField('手机',max_length=15,null=False)
    course_name = models.CharField('课程名',max_length=50,null=False)
...
class UserFavorite(models.Model):
    ...
    user = models.ForeignKey(UserProfile,verbose_name='用户',on_delete=models.CASCADE)
    fav_id = models.IntegerField('被收藏对象的ID(课程或机构)',default=0)
