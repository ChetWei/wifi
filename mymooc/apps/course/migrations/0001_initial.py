# Generated by Django 2.0 on 2018-04-21 19:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('star', models.CharField(default=5, max_length=2, verbose_name='星级')),
                ('category', models.CharField(default='全栈开发', max_length=30, verbose_name='课程类别')),
                ('tag', models.CharField(default='', max_length=20, verbose_name='课程标签')),
                ('course_org', models.ForeignKey(blank=True, default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='organization.CourseOrg', verbose_name='所属机构')),
            ],
            options={
                'verbose_name': '课程',
